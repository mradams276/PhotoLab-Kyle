...
public class Picture extends SimplePicture {
	...
	public void createCollage() {
		Picture flower1 = new Picture("MrChiefSmall.jpg");
		Picture flower2 = new Picture("AnakinSmall.png");
	...
	public void chosenCopy(Picture fromPic, int startRow, int startCol) {
		Pixel fromPixel = null;
		Pixel toPixel = null;
		Pixel[][] toPixels = this.getPixels2D();
		Pixel[][] fromPixels = fromPic.getPixels2D();
	...
	public void decode()
	{
		...
		for (int row = 0; row < decoded.length;)
		{
